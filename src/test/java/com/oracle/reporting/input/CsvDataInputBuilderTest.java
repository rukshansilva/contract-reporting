...
public class CsvDataInputBuilderTest {
		...
		public void testBuildDataObjectSuccess() {
				...
				assertAll(
						...
						() -> assertEquals(((List<CsvContractDataDto>)csvDataInputBuilder.buildDataObject(buildDataObject())).stream().findFirst().get().getBuildduration(), 3445));
		...
		private List<List<String>> buildDataObject () {
			...
			return Arrays.asList(
					Arrays.asList("2343225", "2345", "us_east", "RedTeam", "ProjectApple", "3445"),
					Arrays.asList("1223456", "2345", "us_west", "BlueTeam", "ProjectBanana", "2211s"),
					Arrays.asList("3244332", "2346", "eu_west", "YellowTeam3", "ProjectCarrot", "4322"),
